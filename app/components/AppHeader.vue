...
const featuredEvents = [
  { title: 'Bandung', dateMonth: 'JUN', dateRange: '00', year: '2026', city: 'Nuxtjs Community', country: 'ID', img: './location/bandung.jpg' },
  { title: 'Yogyakarta', dateMonth: 'JUN', dateRange: '00', year: '2026', city: 'Laravel Community', country: 'ID', img: './location/jogja.jpg' },
  { title: 'Jakarta', dateMonth: 'JUL', dateRange: '00', year: '2026', city: 'Angular Community', country: 'ID', img: './location/monas.png' }
]
